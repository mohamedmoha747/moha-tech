    ...
    <section id={id} className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white min-h-[100vh] flex items-center justify-center py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.95fr] gap-10 items-center">
          {/* Left content */}
          <div className="mx-auto lg:mx-0 max-w-3xl text-center lg:text-left space-y-6">
            ...
            <p className="max-w-xl text-slate-400 mx-auto lg:mx-0">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-[380px] bg-slate-900/30 p-6 rounded-[24px] shadow-[0_25px_70px_rgba(0,0,0,0.25)] border border-white/10">
              <div className="w-full max-w-[280px] mx-auto aspect-square overflow-hidden rounded-full border-2 border-white/10 shadow-[0_20px_50px_rgba(15,23,42,0.35)]">
                <img
              ...
              <div className="mt-5 text-center space-y-3">
                <h3 className="text-xl sm:text-2xl font-semibold">Mohamed Harun</h3>
